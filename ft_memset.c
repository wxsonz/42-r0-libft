...
// experiment glibc style, not safe
// 1 of 5~6 will prone to fail with small size

// loop fill byte of until it can fit unsigned long (4 or 8 bytes)
// example
// 0x1000 & 0011 = 0000 (can be fit)
// 0x1001 & 0011 = 0001 (cannot fit)
// 0x1002 & 0011 = 0010 (cannot fit)
// after we done fill byte we loop fill unsigned long bytes
